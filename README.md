...
| [`docs/design-system.md`](docs/design-system.md) | Дизайн-система v3 (тёмная пастельная тема, коралл, Inter, капслок): токены, компоненты с состояниями, доступность, motion, changelog |
